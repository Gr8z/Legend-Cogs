...
class clashroyale:
	...
	async def clashProfile(self, ctx, member: discord.Member = None):
		...
		try :
			...
			embed.set_thumbnail(url="https://royaleapi.github.io/cr-api-assets/arenas/arena{}.png".format(profiledata['arena']['arena']))
			...
			embed.add_field(name="Cards Found", value=str(profiledata['stats']['cardsFound'])+"/82", inline=True)
