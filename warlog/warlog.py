...
class warlog:
    ...
    async def genImage(self, leagueName, trophies, rank, clanName, participants, wins, crowns):
        ...
        draw.text((493, 75), trophies, (255,255,255), font=font1) # Trophies
    ...
    async def getWarData(self, channel):
        ...
        for clankey in self.clans.keys():
            ...
            if self.clans[clankey]['warTrophies'] != warTrophies:
                ...
                image.save("data/warlog/images/warlog_ready.png")

                await self.bot.send_file(channel, "data/warlog/images/warlog_ready.png", filename="warlog.png")
